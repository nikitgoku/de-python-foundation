'''
Mini Exercise: Dictionary and Nested Loops
---------------------------------
Given a complex nested dictionary structure, write a Python script to count the total number of occurrences of
a specific key ('FieldTypeName') within all 'HeaderFields' across all entries in the
'''
...
ata = {"DERF":0,
        ...
        "MAINDATA":[
            ...
            "CodingLines":[
                ...
                "CODE3":"5645654",
                "CODE4":"",
                "CodingFields":[{"FieldName":"COL1","Value":"223DD666"},
...
count = 0    
for maindata in ata['MAINDATA']:
    for header in maindata['HeaderFields']:
        for field in header:
